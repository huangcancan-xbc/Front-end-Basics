...
class DigitalPage {
    ...
    // 加载商品数据
    loadProducts() {
        // 从ProductManager获取数码商品数据
        this.allProducts = this.productManager.products.digital || [];
        this.applyFilters();
    }
        ...
        card.innerHTML = `
            ...
            <div class="product-info">
                ...
                <div class="product-actions">
                    <button class="btn-add-cart" onclick="digitalPage.addToCart('${product.id}')">加入购物车</button>
                </div>
            </div>
        `;
